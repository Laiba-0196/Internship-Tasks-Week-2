...
//
//   
//    int totalParticipants = numSeniorCitizens + numCarers;
//    double costPerPerson = totalCost / totalParticipants;
//
...
int main() {
    ...
    if (totalCollected >= totalCost) {
        ...
        cout << "The outing has incurred a loss of $" << totalCost - totalCollected << "." << endl;
    }
